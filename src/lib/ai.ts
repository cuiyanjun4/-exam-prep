...
export const PROVIDER_MODELS: Record<AIProvider, { label: string; value: string; tag?: string }[]> = {
  ...
  gemini: [
    { label: '🌐 Gemini 3.1 Pro (代理)', value: '[L]gemini-3.1-pro-preview', tag: '代理' },
    { label: '🌐 Gemini 3 Pro (代理)', value: '[L]gemini-3-pro-preview', tag: '代理' },
    { label: '🌐 Gemini 3 Flash 搜索 (代理)', value: '[L]gemini-3-flash-preview-search', tag: '代理' },
    { label: '🌐 Gemini 2.5 Pro (代理)', value: '[L]gemini-2.5-pro', tag: '代理' },
    { label: 'Gemini 2.5 Pro', value: 'gemini-2.5-pro-preview-06-05', tag: '官方' },
    { label: 'Gemini 2.5 Flash', value: 'gemini-2.5-flash-preview-05-20', tag: '官方' },
    { label: 'Gemini 2.0 Flash', value: 'gemini-2.0-flash', tag: '官方' },
    { label: 'Gemini 2.0 Flash Lite', value: 'gemini-2.0-flash-lite', tag: '官方' },
  ],
  tongyi: [
